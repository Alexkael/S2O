...
def eval_adv_test_whitebox(model, device, test_loader, attack_method):
    ...
    natural_err_total1 = 0
    natural_err_total2 = 0
    natural_err_total3 = 0

    for data, target in test_loader:
        data, target = data.to(device), target.to(device)
        X, y = Variable(data, requires_grad=True), Variable(target)
        #err_natural1, fgsm_err_robust = _fgsm_whitebox(model, X, y)
        err_natural2, pgd_err_robust = _pgd_whitebox(model, X, y)
        #err_natural3, cw_err_robust = _cw_whitebox(model, X, y)
        '''
        ...
        natural_err_total1 += err_natural2
    #SVHN
    print('natural_acc_total: ', 1-natural_err_total1/10000)
    #print('fgsm_acc_total: ', 1-fgsm_robust_err_total/10000)
    print('pgd_acc_total: ', 1-pgd_robust_err_total/10000)
    #print('cw_acc_total: ', 1-cw_robust_err_total/10000)
...
def eval_adv_test_blackbox(model_target, model_source, device, test_loader, attack_method):
    ...
    print('natural_err_total: ', 1-natural_err_total/10000)
    print('robust_err_total: ', 1-robust_err_total/10000)
...
def main():
    ...
    if args.white_box_attack:
        ...
        for epoch in range(100,110):
            path = '../model-cifar10-resnet18/0.1/epoch'+str(epoch)+'.pt'
